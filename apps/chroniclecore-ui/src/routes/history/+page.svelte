...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    >
        ...
        <div class="flex items-center gap-3">
            ...
            <div
                class="flex items-center gap-2 bg-white dark:bg-slate-800 p-2 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm"
            >
                <input
                    type="date"
                    bind:value={dateRange.start}
                    class="border-none text-sm text-slate-700 dark:text-slate-300 dark:bg-slate-800 focus:ring-0 p-1"
                />
    ...
    >
        ...
        >
            ...
            <span class="text-sm text-slate-500 dark:text-slate-400"
                >{activityGroups.length} groups</span
            >
        </div>
        <div class="p-4 space-y-3">
            ...
            {:else if activityGroups.length === 0}
                <div class="text-center py-12">
                    <div
                        class="mx-auto w-12 h-12 bg-slate-100 dark:bg-slate-700 rounded-full flex items-center justify-center mb-3 text-slate-400 dark:text-slate-500"
                    >
                        <svg
                            class="w-6 h-6"
                            fill="none"
